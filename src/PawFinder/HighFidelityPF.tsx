  ...
  return (
    <div id={elementId} className="high_fidelity_section_PF">
      <div className="hf_text_container_PF">
        <h1 className="hf_title_PF">{title}</h1>
      ...
      <div className="hf_main_content_PF">
        <div className="hf_font_and_color_container_PF">
          <div className="hf_color_palette_container_PF">
            <p className={`hf_cp_font_size_title_PF font_size_desc ${textColor}65`}>{color.title}</p>
            <h1 className="hf_cp_font_size_desc_PF">{color.desc}</h1>
          ...
          <div className="hf_font_container_PF">
            <p className={`hf_cp_font_size_title_PF font_size_desc ${textColor}65`}>{font.title}</p>
            <h1 className="hf_cp_font_size_desc_PF">{font.desc}</h1>
            <h1 className="hf_cp_font_size_alphabet_PF">{alphabet}</h1>
          </div>
        </div>
        <div className="hf_feel_and_imagery_container_PF">
          <div className="hf_look_and_feel_container_PF">
            <p className={`hf_cp_font_size_title_PF font_size_desc ${textColor}65`}>{look.title}</p>
            <h1 className="hf_cp_font_size_desc_PF hf_cp_font_feel_PF">{look.desc}</h1>
          </div>
