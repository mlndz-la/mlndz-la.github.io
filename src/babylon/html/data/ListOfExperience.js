...
export const listOfExperience = [
  {
    ...
    descriptions: [
      ...
      `
        ...
        <p class='inline'>&nbsp;to monitor changes to the code base and prevent breaking changes as well as deploy git bisect to debug and backtrack to a stable version of Artemis</p>
      `,
    ],
  },
];
