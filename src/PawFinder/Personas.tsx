...
export const Personas = ({
  ...
  return (
    <div
      className="personas_content_PF white_content_border test"
      id={elementId}
    >
      ...
      <div className="personas_image_container_PF">
        <img
          className="personas_image_PF personas_image_one_PF"
          src={personaOne}
          alt="persona one"
        />
        <img
          className="personas_image_PF personas_image_two_PF"
          src={personaTwo}
          alt="persona two"
        />
      </div>
