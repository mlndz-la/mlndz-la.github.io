export const cosmicKitchenData = {
  ...
  mockUpImageTopDesktop:
    "https://raw.githubusercontent.com/mlndz-la/pwAssets/main/CK/Mock-uplanding.png",
  caseStudyStart: {
    ...
    whatWhereWhy: [
      ...
      {
        title: "What",
        subtitle: "Fridge UI / UX",
      },
      {
        title: "Why",
        subtitle: "Fridge Technology",
      },
      {
        title: "Role",
  ...
  researchAndAnalysis: {
    ...
    image:
      "https://raw.githubusercontent.com/mlndz-la/pwAssets/main/CK/Chart.png",
    industryLeader: {
      title: "Industry Leaders",
      list: [
        "LG - Mkt Cap: 15.50 trillion",
        "Samsung - Mkt Cap: 409.96 trillion",
        "Whirlpool - Mkt Cap: 8.08 billion",
        "GE - Mkt Cap: 96.01 billion",
        "Bosch - Mkt Cap: 490.38 billion",
      ],
    },
    refrigeratorType: {
  ...
  users: {
    title: "Users",
    userList: [
      "Monthly incomes of more than $3000 per household.",
      "People between the ages of 30 - 50 are included in this age range.",
      "People with a focus on their health.",
      "Designed for the comfort and convenience of a family.",
      "Urbanized central region.",
    ],
  },
  painPoints: {
    title: "Pain Points",
    ...
    painPointList: [
      "The contents of the refrigerator are often forgotten.",
      "Concern over the expiration of a product.",
      "When people put ingredients away, they often lose track of them.",
      "The need for a centralized location for recipes.",
  ...
  solutions: {
    ...
    solutionsList: [
      "List all of your goods.",
      "Use a barcode scanner to let you know when something is about to expire.",
      "Use of cameras gives a full view of the refrigerators.",
      "Consolidate recipes into an app.",
      "AI with temperature and energy consumption regulation capabilities.",
  ...
  personas: {
    ...
    desc: "User needs access to temperature regulation, recipe app, and refrigerator contents display. U.S. demand is clearly on the rise, despite the fact that the country isn't as large a market as Asia.",
    topImage:
      "https://raw.githubusercontent.com/mlndz-la/pwAssets/main/CK/Vanessa.png",
    bottomImage:
  ...
  futureConsideration: {
    ...
    image:
      "https://raw.githubusercontent.com/mlndz-la/pwAssets/main/CK/updateconcept.png",
  },
  accessibilityCheck: {
    title: "Accessibility Check",
    desc1:
      "We employed contrast checkers to ensure that the use of gray, white, and orange in the dark mode user interface was acceptable so that we could comply with WCAG standards.",
    desc2:
